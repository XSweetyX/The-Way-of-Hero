...
public class ItemStorage {
    ...
    public Items treestick = new Items("Tree Stick","3",2, R.drawable.treestick,1,0,1000,5);
    ...
    public Items woodenshield = new Items("Wooden shield","8",5, R.drawable.rubinring,10,0,4500,14);
